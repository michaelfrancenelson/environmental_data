...
subtitle: "Model Coefficients and the ANOVA Table"
...
source_file = find_file("week_09_3", search_path = source_dir, extension = ".Rmd")
...
```{r anova_and_coef_tables_slides, child = find_file("anova_regression_coef_tables.Rmd")}
```
