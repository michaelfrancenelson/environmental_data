...
knitr::opts_chunk$set(echo = TRUE)
rmd.utils::source_rmd_chunks(rmd.utils::find_file("function_chunks_lab_11.Rmd"))
```
...
powers = matrix(0, nrow = length(sample_sizes), ncol = length(alphas))
...
sim_sample_size = cbind(sample_sizes, powers)
