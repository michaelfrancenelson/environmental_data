...
- Paste the R code you used to create `exp_fun()`

### Q2 3 pts.

- Create a single plot containing 4 curves with these parameter values:
...
```{r echo = FALSE}
{
  curve(exp_fun(x, 1.9, 0.1), add = FALSE, from = 0, to = 30, ylab = "f(x)", ylim = c(0, 2))
  curve(exp_fun(x, 1.9, 0.3), add = TRUE, from = 0, to = 30, col = 1, lty = 2)
  curve(exp_fun(x, 1.2, 0.2), add = TRUE, from = 0, to = 30, col = 2, lty = 1)
  curve(exp_fun(x, 1.2, 0.4), add = TRUE, from = 0, to = 30, col = 2, lty = 2)
}
```
