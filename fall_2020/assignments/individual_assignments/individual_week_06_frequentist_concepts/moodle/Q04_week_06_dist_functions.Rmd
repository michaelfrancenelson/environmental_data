...
mfn.teaching.utils::plot_norm_tails(upper_tail = NULL, lower_tail = pnorm(1.2, mean = 2, sd = 2), fill_lower = fill_lower, fill_upper = fill_upper, fill_middle = fill_middle, pop_mean = 2, pop_sd = 2) +
